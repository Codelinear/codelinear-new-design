              ...
              >
                <div className="w-[360px] h-[100vh] relative bg-white">
                  ...
                  <div className="left-[20.04px] top-[93px] absolute flex-col justify-start items-start gap-3 inline-flex">
                    <Link t0="/" className="w-80 text-black text-4xl font-normal font-['Graphik'] underlin leading-[43.20px]">
                      Home
                    </Link>
                    <Link to="/about" className="w-80 text-black text-4xl font-normal font-['Graphik'] leading-[43.20px]">
                      About Us
                    </Link>
                    <Link to="/service" className="w-80 text-black text-4xl font-normal font-['Graphik'] leading-[43.20px]">
                      Services
                    </Link>
                    <Link to="/case" className="w-80 text-black text-4xl font-normal font-['Graphik'] leading-[43.20px]">
                      Case Studies
                    </Link>
                    <Link to="insights" className="w-80 text-black text-4xl font-normal font-['Graphik'] leading-[43.20px]">
                      Insights
                    </Link>
                    <Link to="/" className="w-80 text-black text-4xl font-normal font-['Graphik'] leading-[43.20px]">
                      Industries
                    </Link>
                    <Link to="/contact" className="justify-start items-start gap-2 inline-flex">
  ...
  <defs>
    <clipPath id="clip0_1663_7264">
      <rect width="23.9998" height="23.9998" fill="white" transform="translate(0.575195)"/>
                      ...
                      <div className="w-6 h-6 relative">
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
  <path d="M10.4198 15L15.6098 12L10.4198 9V15ZM21.9798 7.17C22.1098 7.64 22.1998 8.27 22.2598 9.07C22.3298 9.87 22.3598 10.56 22.3598 11.16L22.4198 12C22.4198 14.19 22.2598 15.8 21.9798 16.83C21.7298 17.73 21.1498 18.31 20.2498 18.56C19.7798 18.69 18.9198 18.78 17.5998 18.84C16.2998 18.91 15.1098 18.94 14.0098 18.94L12.4198 19C8.2298 19 5.6198 18.84 4.5898 18.56C3.6898 18.31 3.1098 17.73 2.8598 16.83C2.7298 16.36 2.6398 15.73 2.5798 14.93C2.5098 14.13 2.4798 13.44 2.4798 12.84L2.4198 12C2.4198 9.81 2.5798 8.2 2.8598 7.17C3.1098 6.27 3.6898 5.69 4.5898 5.44C5.0598 5.31 5.9198 5.22 7.2398 5.16C8.5398 5.09 9.7298 5.06 10.8298 5.06L12.4198 5C16.6098 5 19.2198 5.16 20.2498 5.44C21.1498 5.69 21.7298 6.27 21.9798 7.17Z" fill="black"/>
</svg>
                      </div>
                    </div>
                  </div>
