    ...
    <>
      <footer className="bg-white relative 0 h[1800px]">
        ...
        <div className="down-footer mt-20">
          <div className="w-full pb-[40px] relative bg-white max-lg:h-full">
            <div className="flex gap-[126px] pl-[80px]  max-xl:flex-wrap max-lg:ml-0  max-lg:p-10 max-sm:gap-10 max-lg:gap-10">
              <div className="flex flex-col gap-[83px] max-[350px]:w-full">
                <div className="flex flex-col gap-[36px] max-[350px]:w-full">
                ...
                <div className="w-[390px] left-[80px] top-[723.50px]  opacity-60 text-black text-base font-normal font-['Graphik'] leading-normal max-[350px]:w-full">
                Copyright © Codelinear Software Solutions Pvt Ltd. All Rights Reserved.                </div>
              </div>

              <div className="flex flex-wrap gap-20 w-[700px] max-lg:p-0  max-md:flex-col max-md:w-full max-sm:flex-wrapreverse">
                <div className="flex gap-[80px] pt-20 h-[150px]  max-lg:flex-wrap max-lg:h-[300px] max-sm:h-[400px] max-lg:gap-32 ">
                ...
                <div className="left-[622px] w-[245px]  pt-5 top-[201.89px]  flex-col justify-start items-start gap-[20px] inline-flex max-md:w-full">
                  <div className="text-black text-xl font-normal font-['Graphik'] leading-[30px]">
                    Services
                  </div>
                ...
                <div className="left-[1056px] ml-[-5px] pt-5 top-[201.89px]  flex-col justify-start items-start gap-[20px] inline-flex max-md:flex-wrap max-md:w-full">
                  <div className="text-black text-xl font-normal font-['Graphik'] leading-[30px]">
                    Industries
                  </div>
                ...
                <div className="w-[88px] h-[266px] flex-col pt-5 justify-start items-start gap-[20px] inline-flex max-sm:order-1">
                  <div className="text-black text-xl font-normal font-['Graphik'] leading-[30px]">
                    Sitemap
                  </div>
