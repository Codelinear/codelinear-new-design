            ...
            <div className="max-xl:w-full max-md:ml-0">
              <div className="mt-[80px] max-[500px]:mt-28  flex-col justify-start items-start gap-[30px] inline-flex">
                ...
                <div className="flex-col justify-start items-start gap-[42px] flex">
                  ...
                  <Link className=" max-sm:w-full" onClick={scrollToTop} to={"/ar-vr-services"}>
                    <button className="px-8 max-sm:w-full py-4 rounded-[31px] border border-black justify-center items-center gap-2 inline-flex hover:bg-yellow-400 transition-all  hover:border-yellow-400 max-sm:w-full">
