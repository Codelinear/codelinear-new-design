    ...
    <>
        ...
        <div className="w-full h-[742px] pl-20 pr-[117.55px] pt-[67.83px] pb-[128.12px] bg-white justify-start items-start gap-[61px] inline-flex max-md:h-full">
          ...
          <div className="self-stretch flex-col justify-start items-start gap-[30px] inline-flex max-lg:flex-wrap">
            ...
            <div className="flex-col justify-start items-start gap-[42px] flex">
              ...
              <div className="px-8 py-4 hover:bg-yellow-400 transition-all  hover:border-yellow-400 rounded-[31px] border border-black justify-center items-center gap-2 inline-flex">
      ...
      <div className="cases">
        <div className="w-full h-[742px] pl-20 pr-[117.55px] pt-[67.83px] pb-[128.12px] bg-white justify-start items-start gap-[61px] inline-flex max-md:h-full">
          ...
          <div className="w-[630px] bg-neutral-100 justify-end items-center inline-flex max-md:w-full">
            <img className="w-[649.91px] h-[586.54px] max-md:w-full" src={img2} alt="" />
          </div>
