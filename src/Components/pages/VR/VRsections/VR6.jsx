  ...
  return (
    <>
        ...
        <div className="flex flex-col">
          <div className="ml-[80px] mt-[67px]  flex-col justify-start items-start gap-[22px] inline-flex max-lg:ml-[40px] max-sm:px-[20px] max-sm:ml-[0px]">
            <div className="flex-col max-sm:w-[100%] justify-start items-start gap-[30px] flex">
              ...
              <div className="w-[631.03px] letter-spacing-2 text-black text-[49.20px] font-normal font-['Graphik'] leading-[120%] max-sm:text-[36px] max-lg:w-[100%]">
                AR for E-commerce{" "}
              </div>
            </div>

            <div className="w-[536.02px] h-[85.15px] opacity-80 text-black text-base font-normal font-['Graphik'] leading-normal max-sm:w-[100%] max-sm:h-full">
      ...
      <div className="features">
        <div className="w-full h-[755px] pl-20 pr-[0px] pt-[0px] pb-[145.80px] bg-white justify-start items-start gap-[54px] max-[1100px]:gap-[50px] inline-flex max-lg:flex-wrap max-lg:h-full max-lg:gap-[50px] max-lg:pl-[40px] max-sm:px-[20px] max-sm:gap-[50px]">
          ...
          <div className="w-[522px] max-lg:w-full self-stretch flex-col justify-start max-lg:justify-start items-center inline-flex">
            <img
              className="w-[522px] h-[833.20px] max-sm:w-full max-sm:h-full"
              src={img6}
              alt="h"
            />
          </div>
