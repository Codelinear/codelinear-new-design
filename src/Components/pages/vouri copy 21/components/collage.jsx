    ...
    <>
      <div className="mt-[54.5px] max-lg:px-[16.5px] max-sm:px-0 max-lg:mt-0 max-lg:flex-col mb-[53.5px] gap-[16px] flex flex-col w-[100%]">
        <div className="flex max-lg:flex-col gap-[20px] w-[100%]">
          <img className="w-[50%] max-lg:w-full" src={img4} alt="" />
          <img className="w-[50%] max-lg:w-full" src={img2} alt="" />
        </div>
        <div className="flex max-lg:flex-col gap-[20px] w-[100%]">
          <img className="w-[50%] max-lg:w-full" src={img3} alt="" />
          <img className="w-[50%] max-lg:w-full" src={img1} alt="" />
        </div>
      </div>
    </>
  );
