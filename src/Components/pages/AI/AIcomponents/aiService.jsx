            ...
            <div className="right sticky max-xl:hidden h-[600px] top-28 mt-0  max-xl:w-full bg-white max-xl:h-[300px] max-xl:top-10  max-md:h-[400px] pr-[80px]">
              <div className="self-stretch flex-col justify-start items-start gap-3 inline-flex max-xl:w-full  max-xl:h-[300px]">
                ...
                <div className=" w-[222px] h-[463px] relative left-[30px] max-xl:h-[200px] max-xl:w-full">
                  ...
                  <div className=" stick_list mt-[11px] w-[197px] h-[412px] left-[25px] top-[51px] absolute flex-col justify-start items-start gap-[4px] inline-flex max-xl:flex-row max-xl:flex-wrap  max-xl:w-full  max-xl:h-[200px]  max-lg:relative max-lg:left-[0]">
                    <Link
                      to="#natural-language-processing-solutions"
                    ...
                    >
                      <div className="w-[150px] opacity-80 text-black text-[14px] font-normal font-['Graphik'] leading-[16.80px]">
                    ...
                    >
                      <div className="w-[150px] opacity-80 text-black text-sm font-normal font-['Graphik'] leading-[16.80px]">
                        Voice-enabled Technology
                      </div>
                    </Link>
                    <Link
                      to="#ai-implementation-strategy"
