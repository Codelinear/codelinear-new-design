            ...
            <div className="left">
              ...
              <div>
                <div className="w-full mb-[70px] relative bg-white section max-sm:mb-0">
                  <div className="w-[670px] letter-spacing-6 mt-[130px] max-sm:mt[40px]  text-black text-[36px] font-normal font-['Graphik'] leading-[120%] max-lg:w-[100%] max-sm:text-[24px] max-sm:tracking-tight max-sm:mt-[66px]">
            ...
            <div className="right sticky max-xl:hidden h-[600px] top-28 mt-0  max-xl:w-full bg-white max-xl:h-[300px] max-xl:top-10  max-md:h-[400px] pr-[80px]">
              <div className="self-stretch flex-col justify-start items-start gap-3 inline-flex max-xl:w-full  max-xl:h-[300px]">
                ...
                <div className=" w-[222px] h-[463px] relative left-[30px] max-xl:h-[200px] max-xl:w-full">
                  <div className="w-[220px] overview h-[35px] top-0 absolute rounded-lg justify-center items-center gap-2 inline-flex max-xl:flex-wrap ">
                    <div
                      className={
                        activeSection >= 1
                          ? "active text-black text-base font-normal font-['Graphik'] leading-tight"
                  ...
                  <div className=" stick_list w-[197px] h-[412px] left-[25px] top-[51px] absolute mt-[11px] flex-col justify-start items-start gap-[4px] inline-flex max-xl:flex-row max-xl:flex-wrap  max-xl:w-full  max-xl:h-[200px]  max-lg:relative max-lg:left-[0]">
                    <Link
                      to="#sharepoint-consulting-and-strategy"
                    ...
                    >
                      <div className="w-[167px] opacity-80 text-black text-[14px] font-normal font-['Graphik'] leading-[16.80px]">
                    ...
                    <Link
                      to="#implementation-and-configuration"
