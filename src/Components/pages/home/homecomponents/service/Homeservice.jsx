    ...
    <>
      {width <= 640 ? (
        <div className="homeserv relative">
          <div className="w-full flex-wrap h-[1808px] px-20 py-[50px] bg-neutral-50 flex-col justify-center items-center inline-flex max-lg:h-full max-lg:p-10 max-md:w-full   max-md:p-4">
            <div className="self-stretch flex-wrap justify-start items-start gap-[19px] inline-flex max-md:w-full">
              <div className="h-[150px] pl-[0px] pr-[89.78px] pt-[30px] pb-[31px] flex-col justify-start items-center inline-flex  w-full  max-lg:p-10  max-lg:  max-md:w-full  max-[376px]:h-[100px] max-md:p-2">
           ...
           <div className="flex flex-wrap">
              ...
              <div className=" service-cards w-[414px] h-[459px] pl-[30px] pr-11 pt-[66px] pb-[43px] bg-white flex-col justify-end items-start gap-[47.30px] inline-flex  transitionall text-black    max-lg:w-full">
                <div className="w-[101.70px] h-[101.70px] pl[13.21px] pr-[13.77px] pt-[9.42px] pb-[8.86px] justify-center items-center inline-flex">
                  <div className="w-[74.73px] h-[83.42px] relative flex-col justify-start items-start flex">
                    <svg
              ...
              <div className=" service-cards w-[414px] h-[459px] pl-[30px] pr-11 pt-[66px] pb-[43px] bg-white flex-col justify-end items-start gap-[47.30px] inline-flex  transition-ll   text-black   max-lg:w-full">
                <div className="w-[101.70px] h-[101.70px] pl[13.21px] pr-[13.77px] pt-[9.42px] pb-[8.86px] justify-center items-center inline-flex">
                  <div className="w-[74.73px] h-[83.42px] relative flex-col justify-start items-start flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className=" service-cards w-[414px] h-[459px] pl-[30px] pr-11 pt-[66px] pb-[43px] bg-white flex-col justify-end items-start gap-[47.30px] inline-flex  transitionall  text-black  ">
                <div className="w-[101.70px] h-[101.70px] pl[13.21px] pr-[13.77px] pt-[9.42px] pb-[8.86px] justify-center items-center inline-flex">
                  <div className="w-[74.73px] h-[83.42px] relative flex-col justify-start items-start flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className=" service-cards w-[414px] h-[459px] pl-[30px] pr-11 pt-[66px] pb-[43px] bg-white flex-col justify-end items-start gap-[47.30px] inline-flex  transition-ll   text-black  ">
                <div className="w-[101.70px] h-[101.70px] pl-[13.21px] pr-[13.77px] pt-[9.42px] pb-[8.86px] justify-center items-center inline-flex">
                  <div className="w-[74.73px] h-[83.42px] relative flex-col justify-start items-start flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="homeserv relative">
          <div className="w-full flex-wrap h-[1808px] px-20 py-[50px] bg-neutral-50 flex-col justify-center items-center inline-flex max-lg:h-full max-lg:p-10 max-md:w-full   max-md:p-4">
            <div className="self-stretch flex-wrap justify-start items-start gap-[19px] inline-flex max-md:w-full">
              <div className="h-[150px] pl-[0px] pr-[89.78px] pt-[30px] pb-[31px] flex-col justify-start items-center inline-flex  w-full  max-lg:p-10  max-lg:  max-md:w-full  max-[376px]:h-[400px] max-md:p-2">
                <div className="self-stretch flexcol justify-between  items-start gap-10 inline-flex  max-md:flex-wrap">
                  <div className="w-[300.22px] text-black text-[49.20px] font-normal font-['Graphik'] leading-[59.04px] max-[350px]:w-full">
                    Our Services
                  </div>
              ...
              {/* <div className=" service-cards pl-[30px] pr-11 pt-[254px] pb-[51px] bg-white flex-col justify-end items-center inline-flex">
              <div className="flex-col justify-end items-start gap-6 inline-flex">
                    <div className="w-[340px] flex-col justify-between items-start flex gap-6">
                  <div className="service-heading text-black text-2xl font-normal font-['Graphik'] leading-[28.80px]">
                    Technology Consulting
                  </div>
                  <div className="w-[340px] opacity-80 text-black text-base font-normal font-['Graphik'] leading-normal">
                    Our commitment is not just to design; it's to create
                    experiences that resonate, innovate, and lead industries
                    into a bold new era.
                  </div>
